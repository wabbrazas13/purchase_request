    ...
    while($row=mysqli_fetch_assoc($res))
    {
        ...
        ?>
            ...
            <tr>
                ...
                <td style="text-align: right;"><?php echo '₱ '.number_format($temp_item_unit_cost).'.00'; ?></td>
                <td style="text-align: right;"><?php echo '₱ '.number_format($temp_item_total_cost).'.00'; ?></td>
                <td style="text-align: center;">
                    <div class="col1">
                        <button title="Delete" class="btn btn-danger" name="btn_delItem" formaction="<?php echo htmlspecialchars('del_temp_item1.php?temp_item_no='.$temp_item_no); ?>">
                            <i class="fa-solid fa-square-xmark"></i>
                        </button>
                    </div>
                    <div class="col1">
                        <button type="submit" name="btn_editItem" title="Edit" class="btn btn-success" formaction="<?php echo htmlspecialchars('edit_item2.php?temp_item_no='.$temp_item_no); ?>">
