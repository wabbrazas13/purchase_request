<?php 
  ...
  if(isset($_GET['pr_no'])){
    ...
    if(!($res1==true)){
      ...
      $pr_date = $row['pr_date'];
      $pr_purpose = str_replace('<br />', '', $row['pr_purpose']);
      $requested_by = $row['requested_by'];
      $recommending_approval = $row['recommending_approval'];
      $approved_by = $row['approved_by'];
    }
      
    $sql = "SELECT * FROM tbl_item WHERE pr_no = '$pr_no' ";
    $res2 = mysqli_query($link,$sql);

    if($res==true && $res1==true && $res2==true){
      while($row=mysqli_fetch_assoc($res2)){
        $temp_item_unit = $row['item_unit'];
        $temp_item_description = $row['item_description'];
        $temp_item_quantity = $row['item_quantity'];
        $temp_item_unit_cost = $row['item_unit_cost'];
        $temp_item_total_cost = $row['item_total_cost'];
      ...
      <form method="POST">
          ...
          <div>
            <div>
              <table style="width: 100%; height: 100%;">
                ...
                <?php include 'view_temp_item1.php'; ?>
              </table>    
            </div>
            <div style="text-align: center; border-left: 1px solid grey; border-bottom: 1px solid grey; border-right: 1px solid grey; background-color: black; color: white;">
        ...
        <div class="add-pr-container" style="zoom: 1.1;">
          <div style="text-align: center;">
            <h1 class="lbly" style="font-size: 25px; font-weight: bold; position:relative; z-index: 800; color: black;">EDIT PURCHASE REQUEST</h1>
          </div>
          ...
          <div id="pr_form" style="display: flex; justify-content: center;">
            <div class="form-group col1">
              ...
              <label class="lbly">Budget Officer : </label><b style="color: red; margin-left: 195px;"><?php echo $txt_bo;?></b><br>
              <div class="col1">
              ...
              <div class="col2" title="Add Person">
                  ...
                  <button title="Edit Person" class="btn btn-primary" name="btn_bo" type="submit" formaction="<?php echo htmlspecialchars('edit_bo2.php');?>">
              ...
              <label class="lbly">Date : </label><br>
              <input class="form-control" type="date" name="pr_date" value="<?php echo $pr_date;?>"><br>
            ...
            <div class="form-group col1">
              <div class="col2" style="height: 353px; margin-left: 40px;">
                ...
                <?php include "signatories_input1.php";?>
              </div>
            </div>
          </div>
          <hr style="color: black;">
            ...
            <div class="col1">
              <div class="col1">
                <a href="edit_cancel.php">
                  <button type="button" class="btn btn-danger"><i class="fa-sharp fa-solid fa-xmark"></i> Cancel</button>
                </a>
              </div>
              <button type="submit" name="btn_update" class="btn btn-info" formaction="<?php echo htmlspecialchars('update_pr.php');?>"><i class="fa-solid fa-pen-to-square"></i> Update</button> 
            </div>
          </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="margin-top: 10px;">
                        ...
                        <button style="width: 80px;" type="submit" name="btn_saveItem" class="btn btn-success" formaction="<?php echo htmlspecialchars('add_item1.php'); ?>">Save</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="add-person-modal">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer" style="margin-top: 10px;">
                <button style="width: 80px;" type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                <button style="width: 80px;" type="submit" class="btn btn-success" name="btn_savePerson" formaction="<?php echo htmlspecialchars('add_signatories3.php');?>">Save</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="add-person-modal1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer" style="margin-top: 10px;">
                <button style="width: 80px;" type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                <button style="width: 80px;" type="submit" class="btn btn-success" name="btn_savePerson" formaction="<?php echo htmlspecialchars('add_signatories4.php');?>">Save</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="add-person-modal2">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer" style="margin-top: 10px;">
                <button style="width: 80px;" type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                <button style="width: 80px;" type="submit" class="btn btn-success" name="btn_savePerson" formaction="<?php echo htmlspecialchars('add_signatories5.php');?>">Save</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="add-bo-modal">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer" style="margin-top: 10px;">
                <button style="width: 80px;" type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button>
                <button style="width: 80px;" type="submit" class="btn btn-success" name="btn_savePerson" formaction="<?php echo htmlspecialchars('add_bo1.php');?>">Save</button>
              </div>
            </div>
          </div>
        </div>
