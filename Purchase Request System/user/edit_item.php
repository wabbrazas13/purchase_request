...
<body>
    <form action="<?php echo htmlspecialchars('edit_item1.php'); ?>" method="POST">
        <div class="box1">
        ...
        <div class="box4">
            ...
            <br>
            <div class="box4b">
                <textarea name="temp_item_description" cols="52" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' required><?php echo str_replace('<br />','',$temp_item_description);?></textarea><br>
            </div>
        </div>
        <div class="box5">
            <br>
        ...
        <div class="btn">
            <div style="display: inline-block;">
                <a href="purchase_request_form.php">
