...
<div>
    ...
    <div class="col2" title="Add Person">
        ...
        <button title="Edit Person" class="btn btn-primary" name="btn_rb" type="submit" formaction="<?php echo htmlspecialchars('edit_personB.php');?>">
...
<div>
    ...
    <div class="col2" title="Add Person">
        ...
        <button title="Edit Person" class="btn btn-primary" name="btn_ra" type="submit" formaction="<?php echo htmlspecialchars('edit_personB.php');?>">
            <i class="fa-solid fa-user-pen"></i>
        </button>
    </div>
</div><br>
...
<div>
    ...
    <div class="col2">
        ...
        <button title="Edit Person" class="btn btn-primary" name="btn_ab" type="submit" formaction="<?php echo htmlspecialchars('edit_personB.php');?>">
            <i class="fa-solid fa-user-pen"></i>
        </button>
    </div>
</div>